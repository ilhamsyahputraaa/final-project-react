...
const EditPost = () => {
  ...
  const updatePost = useFormik({
    ...
    onSubmit: (values) => {
      if (
        window.confirm(
          "Are you sure? The changes you make will be saved in the system and cannot be undone."
        )
      ) {
        axios({
          method: "post",
            ...
            <div className="uploadPost-area">
              <div className="uploadPost-bubble  m-auto mb-5">
                ...
                <Form onSubmit={updatePost.handleSubmit}>
                  <Form.Group
                    controlId="caption"
                    className="uploadPost-group mb-2">
                    <Form.Label className="uploadPost-label">
                      Caption
                    </Form.Label>
                    <Form.Control
                      onBlur={updatePost.handleBlur}
                      onChange={updatePost.handleChange}
                      value={updatePost.values.caption}
                    />
                    <Form.Text style={formErrorStyle}>
                      {updatePost.touched.caption && updatePost.errors.caption}
                    </Form.Text>
                  </Form.Group>
                  ...
                  <Form.Group
                    ...
                    <Form.Control
                      type="text"
                      onChange={updatePost.handleChange}
                      value={updatePost.values.imageUrl}
                    />
                    <Form.Text style={formErrorStyle}>
                      {updatePost.touched.imageUrl &&
                        updatePost.errors.imageUrl}
                    </Form.Text>
                  </Form.Group>
