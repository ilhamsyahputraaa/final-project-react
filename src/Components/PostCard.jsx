  ...
  return (
    <Card style={{ width: "100%" }} id="PostCard" key={props.i}>
      <Col id="UserPost" onClick={() => window.location.assign("/profile")}>
        <Col id="UserName">
          <div id="AvatarImage">
            <img src={props.avatar} alt="" className="AvatarPost" />
          </div>
          {props.username}
        </Col>
      </Col>
      <Card.Img
        variant="top"
        src={props.postImage}
        onClick={() => window.location.assign(`/detail?postId=${props.postId}`)}
      />
      <Card.Body className="d-flex row gap-3">
        <Col id="ActionButtonPost">
          <FontAwesomeIcon
            ...
            onClick={() => {
              props.isLike ? props.handleUnlike() : props.handleLike();
            }}
          />
        ...
        <Col>
          <Button variant="primary" href={`/detail?postId=${props.postId}`}>
            View Post
          </Button>
        </Col>
      </Card.Body>
